...
class ThreeOfKind
{
    protected string $comboName = 'тройка';
    ...
    public function comboExist()
    {
        ...
        $cardsPool->push(new Card(5,2,4,'9','s'));
        ...
        echo 'Есть '.$this->comboName.': '.(int)!!$checker->check('threeOfKind').PHP_EOL;
    }
    ...
    public function comboNotExist()
    {
        ...
        echo 'Нет ' . $this->comboName . ': ' . (int)$checker->check('threeOfKind');
    }
}
