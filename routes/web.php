...
Route::get('redirect/google',[\App\Http\Controllers\AuthController::class,'google']);
Route::post('login', [\App\Http\Controllers\AuthController::class, 'login'])->name('login');
Route::get('enter', [\App\Http\Controllers\AuthController::class, 'index'])->name('login.page');
